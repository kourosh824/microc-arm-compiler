"builtin.module"() ({
  ...
  ^bb3:  // 2 preds: ^bb1, ^bb2
    ...
    %19 = "llvm.sub"(%17, %18) <{overflowFlags = #llvm.overflow<nsw>}> : (i32, i32) -> i32
    ...
    %22 = "llvm.mul"(%20, %21) <{overflowFlags = #llvm.overflow<nsw>}> : (i32, i32) -> i32
    "llvm.store"(%22, %9) <{alignment = 4 : i64, ordering = 0 : i64}> : (i32, !llvm.ptr) -> ()
